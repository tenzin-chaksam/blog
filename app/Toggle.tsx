...
export default function ThemeToggle() {
  ...
  const updateCSSVariables = (theme: "light" | "dark") => {
    ...
    if (theme === "dark") {
      ...
      root.style.setProperty("--foreground", "#fcfcfc");
  ...
  return (
    <button
      onClick={toggleTheme}
      className="cursor-pointer inline-flex hover:bg-gray-200 dark:hover:bg-[#313131] active:bg-gray-300 dark:active:bg-[#242424] rounded-sm p-2 transition-[background-color]"
    >
      {theme === "dark" ? (
